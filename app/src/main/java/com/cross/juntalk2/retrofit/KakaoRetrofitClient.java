...
public class KakaoRetrofitClient {
    private static final String TAG = KakaoRetrofitClient.class.getSimpleName();
    private static HttpLoggingInterceptor logging = new HttpLoggingInterceptor().setLevel(HttpLoggingInterceptor.Level.BODY);

    private static class LazyHolder {
        static final KakaoRetrofitClient INSTANCE = new KakaoRetrofitClient();
    }

    private static RetrofitService serverInterface;

    private KakaoRetrofitClient() {
        init();
    }

    public static KakaoRetrofitClient getInstance() {
        return LazyHolder.INSTANCE;
    }

    public static RetrofitService getServerInterface() {
