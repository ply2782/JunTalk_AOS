...
public class ChattingRoomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private SimpleDateFormat todayDateFormat = new SimpleDateFormat("yyyy-MM-dd", Locale.KOREA);
    ...
    public ChattingRoomAdapter(Context context, Activity activity) {
    ...
    public int getItemViewType(int position) {
        ...
        if (chattingModelList.get(position).userMessageType.equals(ChattingModel.MessageType.ENTER) &&
            ...
            if (chattingModelList.get(position).userId.equals(myModel.userId)) {
                return R.layout.adapter_chatting_you;
            } else {
                return R.layout.adapter_chatting_me;
            }
        }
        Log.e("currentViewType" , "chattingModelList.get(position).userMessageType : "+ chattingModelList.get(position).userMessageType
        +" chattingModelList.get(position).userState : "+ chattingModelList.get(position).userState);
        return -1;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case R.layout.adapter_chatting_me:
                AdapterChattingMeBinding meItemBinding = AdapterChattingMeBinding.inflate(inflater, parent, false);
                meItemBinding.setChattingRoomAdapter(this);
                return new ChattingMeViewHolder(meItemBinding);
            case R.layout.adapter_chatting_you:
                AdapterChattingYouBinding youItemBinding = AdapterChattingYouBinding.inflate(inflater, parent, false);
    ...
    public class ChattingMeViewHolder extends RecyclerView.ViewHolder {
        ...
        private AdapterChattingMeBinding meItemBinding;

        public ChattingMeViewHolder(@NonNull @NotNull AdapterChattingMeBinding meItemBinding) {
        ...
        public void onBind(ChattingModel chattingModel) {
            try {
                if (chattingModel.chatting_ImageFile == null) {
                    if (chattingModel.chatting_VideoFile != null) {
    ...
    public class ChattingYouViewHolder extends RecyclerView.ViewHolder {
        private AdapterChattingYouBinding youItemBinding;

        public ChattingYouViewHolder(@NonNull @NotNull AdapterChattingYouBinding youItemBinding) {
